...
export const DIFFICULTY_CONFIG: Record<
  Difficulty,
  { gridSize: number; minWalls: number; maxWalls: number; undoLimit: number }
> = {
  easy:   { gridSize: 7,  minWalls: 4,  maxWalls: 7,  undoLimit: 5 },
  normal: { gridSize: 9,  minWalls: 8,  maxWalls: 13, undoLimit: 3 },
  hard:   { gridSize: 11, minWalls: 14, maxWalls: 22, undoLimit: 1 },
};
